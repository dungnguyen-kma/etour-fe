...
export default function GuestHeader() {
  return (
    <div className="bg-[#484848] shadow-md h-14 lg:h-16 flex flex-row fixed top-0 w-full justify-between lg:py-3.5 md:py-3 py-3 z-20">
      ...
      <div className="flex gap-6 lg:pr-12 md:pr-4 pr-4 items-center">
        <div>
          <Link key={"search"} href={"/search"}>
            <button className="text-white w-5 h-5 pt-1 opacity-70 hover:opacity-100">
