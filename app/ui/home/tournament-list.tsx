              ...
              <div className="h-full p-1 border-transparent hover:rounded-2xl hover:bg-[#ef8e5e] active:bg-[#ef8e5e]">
                <div className="flex flex-col gap-0 h-[calc(100%-8px)] rounded-2xl border border-black bg-[#191919] text-lg overflow-hidden">
                  ...
                  <div className="flex flex-col gap-8 p-7">
                    ...
                    <button className="text-base rounded-full italic text-white font-bold w-full h-12 min-w-12 pe-5 ps-5 gap-2 bg-gradient-to-b from-[#606060] to-[#484848] hover:bg-gradient-to-b hover:from-[#484848] hover:to-[#3a3a3a]">
                      VIEW 
                    </button>
                  </div>
                </div>
